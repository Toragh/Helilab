...
MODEL                = heli_q8_part3_problem3_m_integral
MODULES              = heli_q8_part3_problem3_m_integral_data.c heli_q8_part3_problem3_m_integral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_part3_problem3_m_integral.mk
...
MODELLIB                  = heli_q8_part3_problem3_m_integrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_part3_problem3_m_integral_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_part3_problem3_m_integral_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\DEL~~2
