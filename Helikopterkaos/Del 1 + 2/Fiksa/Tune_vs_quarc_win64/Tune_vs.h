 ...
 */
#ifndef RTW_HEADER_Tune_vs_h_
#define RTW_HEADER_Tune_vs_h_
#include <string.h>
#ifndef Tune_vs_COMMON_INCLUDES_
# define Tune_vs_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Tune_vs_COMMON_INCLUDES_ */

#include "Tune_vs_types.h"
...
#define Tune_vs_rtModel                RT_MODEL_Tune_vs_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } forskjellie_PWORK;                 /* '<S4>/forskjell i e' */
...
#define rtB                            Tune_vs_B
#define BlockIO                        B_Tune_vs_T
#define rtX                            Tune_vs_X
#define ContinuousStates               X_Tune_vs_T
#define rtXdot                         Tune_vs_XDot
#define StateDerivatives               XDot_Tune_vs_T
#define tXdis                          Tune_vs_XDis
#define StateDisabled                  XDis_Tune_vs_T
#define rtP                            Tune_vs_P
#define Parameters                     P_Tune_vs_T
#define rtDWork                        Tune_vs_DW
#define D_Work                         DW_Tune_vs_T
...
struct P_Tune_vs_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Constant_Value;               /* Expression: 29.5
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Gain_Gain_c;                  /* Expression: 6.8
...
extern P_Tune_vs_T Tune_vs_P;

/* Block signals (auto storage) */
extern B_Tune_vs_T Tune_vs_B;

/* Continuous states (auto storage) */
extern X_Tune_vs_T Tune_vs_X;

/* Block states (auto storage) */
extern DW_Tune_vs_T Tune_vs_DW;
...
extern void Tune_vs_initialize(void);
extern void Tune_vs_output0(void);
extern void Tune_vs_update0(void);
extern void Tune_vs_output(int_T tid);
extern void Tune_vs_update(int_T tid);
extern void Tune_vs_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Tune_vs_T *const Tune_vs_M;
 ...
 *
 * '<Root>' : 'Tune_vs'
 * '<S1>'   : 'Tune_vs/Conversion'
 * '<S2>'   : 'Tune_vs/Degrees to Radians'
 * '<S3>'   : 'Tune_vs/Degrees to Radians1'
 * '<S4>'   : 'Tune_vs/Elevation controller'
 * '<S5>'   : 'Tune_vs/Heli 3D'
 * '<S6>'   : 'Tune_vs/Joystick'
 * '<S7>'   : 'Tune_vs/Pitch controller'
 * '<S8>'   : 'Tune_vs/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'Tune_vs/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'Tune_vs/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'Tune_vs/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'Tune_vs/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'Tune_vs/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_Tune_vs_h_ */
