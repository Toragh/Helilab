...
MODEL                = Tune_vs
MODULES              = Tune_vs_data.c Tune_vs_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = Tune_vs.mk
...
MODELLIB                  = Tune_vslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Tune_vs_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Tune_vs_quarc_win64
