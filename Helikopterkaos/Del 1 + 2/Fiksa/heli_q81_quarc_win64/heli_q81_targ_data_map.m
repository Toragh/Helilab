  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q81_P.Integrator_UpperSat
	  section.data(27).logicalSrcIdx = 102;
	  section.data(27).dtTransOffset = 26;
	
	  ;% heli_q81_P.Integrator_LowerSat
	  section.data(28).logicalSrcIdx = 103;
	  section.data(28).dtTransOffset = 27;
	
	  ;% heli_q81_P.zerooutputconstant_Value
	  section.data(29).logicalSrcIdx = 104;
	  section.data(29).dtTransOffset = 28;
	
	  ;% heli_q81_P.K_ep_Gain
	  section.data(30).logicalSrcIdx = 105;
	  section.data(30).dtTransOffset = 29;
	
	  ;% heli_q81_P.K_ed_Gain
  ...
  targMap.checksum0 = 3982677526;
  targMap.checksum1 = 2870214020;
  targMap.checksum2 = 4165917615;
  targMap.checksum3 = 316394605;
