...
void heli_q81_output0(void)            /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    ...
    heli_q81_B.Constant = heli_q81_P.Constant_Value;

    /* Constant: '<Root>/Constant1' */
    heli_q81_B.Constant1 = heli_q81_P.v_star;
    ...
    if (heli_q81_B.RateTransitionx > heli_q81_P.DeadZonex_End) {
      rtb_Gain1_idx_4 = heli_q81_B.RateTransitionx - heli_q81_P.DeadZonex_End;
    } else if (heli_q81_B.RateTransitionx >= heli_q81_P.DeadZonex_Start) {
      rtb_Gain1_idx_4 = 0.0;
    } else {
      rtb_Gain1_idx_4 = heli_q81_B.RateTransitionx - heli_q81_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    heli_q81_B.Joystick_gain_x = heli_q81_P.Gainx_Gain * rtb_Gain1_idx_4 *
      heli_q81_P.Joystick_gain_x;

    /* Gain: '<Root>/Scale ' */
    heli_q81_B.Scale = heli_q81_P.Scale_Gain * heli_q81_B.Joystick_gain_x;
    ...
    /* Gain: '<S11>/Gain' */
    heli_q81_B.Gain = heli_q81_P.Gain_Gain * heli_q81_B.TravelCounttorad;
  }

  /* Gain: '<S12>/Gain' incorporates:
   *  TransferFcn: '<S3>/Travel: Transfer Fcn'
   */
  heli_q81_B.Gain_d = (heli_q81_P.TravelTransferFcn_C *
   ...
   */
  heli_q81_B.Gain_b = (heli_q81_P.PitchTransferFcn_C *
                       heli_q81_X.PitchTransferFcn_CSTATE +
                       heli_q81_P.PitchTransferFcn_D *
                       heli_q81_B.PitchCounttorad) * heli_q81_P.Gain_Gain_ae;
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    ...
    /* Gain: '<S7>/Gain' */
    heli_q81_B.Gain_e = heli_q81_P.Gain_Gain_lv * heli_q81_B.ElevationCounttorad;
  }

  /* Gain: '<S8>/Gain' incorporates:
   *  TransferFcn: '<S3>/Elevation: Transfer Fcn'
   */
  heli_q81_B.Gain_dg = (heli_q81_P.ElevationTransferFcn_C *
  ...
  /* Gain: '<Root>/Gain1' */
  rtb_Gain1_idx_4 = heli_q81_P.Gain1_Gain * heli_q81_B.Gain_e;
  rtb_Gain1_idx_5 = heli_q81_P.Gain1_Gain * heli_q81_B.Gain_dg;
   ...
   *  Sum: '<S5>/Sum'
   */
  rtb_Frontgain = heli_q81_P.w_0 * heli_q81_P.w_0 / (heli_q81_P.k_f *
    heli_q81_P.l_p / (2.0 * heli_q81_P.m_p * heli_q81_P.l_p * heli_q81_P.l_p)) *
    ((heli_q81_B.Scale - heli_q81_P.Gain1_Gain * heli_q81_B.Gain_d) *
     heli_q81_P.k_rp - heli_q81_P.Gain1_Gain * heli_q81_B.Gain_i) - 2.0 *
    heli_q81_P.w_0 / (heli_q81_P.k_f * heli_q81_P.l_p / (2.0 * heli_q81_P.m_p *
    heli_q81_P.l_p * heli_q81_P.l_p)) * (heli_q81_P.Gain1_Gain *
    heli_q81_B.Gain_b);
   ...
   *  Limited Integrator
   */
  if (heli_q81_X.Integrator_CSTATE >= heli_q81_P.Integrator_UpperSat ) {
    heli_q81_X.Integrator_CSTATE = heli_q81_P.Integrator_UpperSat;
  } else if (heli_q81_X.Integrator_CSTATE <= (heli_q81_P.Integrator_LowerSat) )
  {
    heli_q81_X.Integrator_CSTATE = (heli_q81_P.Integrator_LowerSat);
  }

  rtb_Backgain = heli_q81_X.Integrator_CSTATE;
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    /* Constant: '<Root>/zero output constant' */
    heli_q81_B.zerooutputconstant = heli_q81_P.zerooutputconstant_Value;
  }

  /* Sum: '<S2>/Sum' incorporates:
   *  Sum: '<Root>/Sum2'
   */
  rtb_Sum_p = heli_q81_B.Constant - (rtb_Gain1_idx_4 -
    heli_q81_B.zerooutputconstant);
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Backgain = ((heli_q81_P.K_ep_Gain * rtb_Sum_p + rtb_Backgain) -
                  heli_q81_P.K_ed_Gain * rtb_Gain1_idx_5) + heli_q81_B.Constant1;
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Backgain = (rtb_Backgain - rtb_Frontgain) * heli_q81_P.Backgain_Gain;

  /* Gain: '<S6>/K_ei' */
  heli_q81_B.K_ei = heli_q81_P.K_ei_Gain * rtb_Sum_p;
  if (rtmIsMajorTimeStep(heli_q81_M)) {
  }

  /* Gain: '<S1>/Front gain' */
  rtb_Gain1_idx_4 *= heli_q81_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_Gain1_idx_4 > heli_q81_P.FrontmotorSaturation_UpperSat) {
    heli_q81_B.FrontmotorSaturation = heli_q81_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Gain1_idx_4 < heli_q81_P.FrontmotorSaturation_LowerSat) {
    heli_q81_B.FrontmotorSaturation = heli_q81_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q81_B.FrontmotorSaturation = rtb_Gain1_idx_4;
  }

  /* End of Saturate: '<S3>/Front motor: Saturation' */

  /* Saturate: '<S3>/Back motor: Saturation' */
  if (rtb_Backgain > heli_q81_P.BackmotorSaturation_UpperSat) {
    heli_q81_B.BackmotorSaturation = heli_q81_P.BackmotorSaturation_UpperSat;
  } else if (rtb_Backgain < heli_q81_P.BackmotorSaturation_LowerSat) {
    heli_q81_B.BackmotorSaturation = heli_q81_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q81_B.BackmotorSaturation = rtb_Backgain;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q81_M)) {
    ...
    if (heli_q81_B.RateTransitiony > heli_q81_P.DeadZoney_End) {
      rtb_Gain1_idx_4 = heli_q81_B.RateTransitiony - heli_q81_P.DeadZoney_End;
    } else if (heli_q81_B.RateTransitiony >= heli_q81_P.DeadZoney_Start) {
      rtb_Gain1_idx_4 = 0.0;
    } else {
      rtb_Gain1_idx_4 = heli_q81_B.RateTransitiony - heli_q81_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S4>/Gain: y'
     */
    heli_q81_B.Joystick_gain_y = heli_q81_P.Gainy_Gain * rtb_Gain1_idx_4 *
...
void heli_q81_derivatives(void)
{
  ...
  /* Derivatives for Integrator: '<S6>/Integrator' */
  {
    boolean_T lsat;
    boolean_T usat;
    lsat = ( heli_q81_X.Integrator_CSTATE <= (heli_q81_P.Integrator_LowerSat) );
    usat = ( heli_q81_X.Integrator_CSTATE >= heli_q81_P.Integrator_UpperSat );
    if ((!lsat && !usat) ||
        (lsat && (heli_q81_B.K_ei > 0)) ||
        (usat && (heli_q81_B.K_ei < 0)) ) {
      ((XDot_heli_q81_T *) heli_q81_M->ModelData.derivs)->Integrator_CSTATE =
        heli_q81_B.K_ei;
    } else {
      /* in saturation */
      ((XDot_heli_q81_T *) heli_q81_M->ModelData.derivs)->Integrator_CSTATE =
...
RT_MODEL_heli_q81_T *heli_q81(void)
{
  ...
  heli_q81_P.Integrator_UpperSat = rtInf;
  heli_q81_P.Integrator_LowerSat = rtMinusInf;
  ...
  /* External mode info */
  heli_q81_M->Sizes.checksums[0] = (3982677526U);
  heli_q81_M->Sizes.checksums[1] = (2870214020U);
  heli_q81_M->Sizes.checksums[2] = (4165917615U);
  heli_q81_M->Sizes.checksums[3] = (316394605U);
  ...
  /* Initialize Sizes */
  heli_q81_M->Sizes.numContStates = (4);/* Number of continuous states */
  ...
  heli_q81_M->Sizes.numBlocks = (57);  /* Number of blocks */
  heli_q81_M->Sizes.numBlockIO = (22); /* Number of block outputs */
