...
typedef struct {
  ...
  real_T zerooutputconstant;           /* '<Root>/zero output constant' */
  real_T K_ei;                         /* '<S6>/K_ei' */
...
struct P_heli_q81_T_ {
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Scale_Gain;                   /* Expression: 1
                                        * Referenced by: '<Root>/Scale '
                                        */
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S6>/Integrator'
                                        */
  real_T zerooutputconstant_Value;     /* Expression: (29*pi)/180
 ...
 * '<S2>'   : 'heli_q81/Elevation controller'
 * '<S3>'   : 'heli_q81/Heli 3D'
 * '<S4>'   : 'heli_q81/Joystick'
 * '<S5>'   : 'heli_q81/Pitch controller'
 * '<S6>'   : 'heli_q81/Elevation controller/Elevation controller'
 * '<S7>'   : 'heli_q81/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'heli_q81/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'heli_q81/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'heli_q81/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'heli_q81/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'heli_q81/Heli 3D/Travel rate  rad to deg'
 */
