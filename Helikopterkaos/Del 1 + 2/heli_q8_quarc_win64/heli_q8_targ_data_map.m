  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.TimeStampA
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 65;
	
	  ;% heli_q8_DW.LastUAtTimeA
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 66;
	
	  ;% heli_q8_DW.TimeStampB
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 67;
	
	  ;% heli_q8_DW.LastUAtTimeB
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 68;
	
	  ;% heli_q8_DW.TimeStampA_m
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 69;
	
	  ;% heli_q8_DW.LastUAtTimeA_m
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 70;
	
	  ;% heli_q8_DW.TimeStampB_f
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 71;
	
	  ;% heli_q8_DW.LastUAtTimeB_g
	  section.data(17).logicalSrcIdx = 16;
  ...
  targMap.checksum0 = 503566980;
  targMap.checksum1 = 4157412518;
  targMap.checksum2 = 1496533947;
  targMap.checksum3 = 3615739277;
