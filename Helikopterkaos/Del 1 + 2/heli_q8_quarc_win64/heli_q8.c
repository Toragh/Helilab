 ...
 * C source code generated on : Sun Oct 14 13:27:01 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/Scale ' */
    heli_q8_B.Scale = heli_q8_P.Scale_Gain * heli_q8_B.Joystick_gain_x;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/Gain1' */
    heli_q8_B.Gain1 = heli_q8_P.Gain1_Gain * heli_q8_B.Gain_i;
  }

  /* Derivative: '<Root>/Derivative1' */
  if ((heli_q8_DW.TimeStampA >= heli_q8_M->Timing.t[0]) &&
      (heli_q8_DW.TimeStampB >= heli_q8_M->Timing.t[0])) {
    rtb_PitchTransferFcn = 0.0;
  } else {
    rtb_Backgain = heli_q8_DW.TimeStampA;
    lastU = &heli_q8_DW.LastUAtTimeA;
    if (heli_q8_DW.TimeStampA < heli_q8_DW.TimeStampB) {
      if (heli_q8_DW.TimeStampB < heli_q8_M->Timing.t[0]) {
        rtb_Backgain = heli_q8_DW.TimeStampB;
        lastU = &heli_q8_DW.LastUAtTimeB;
      }
    } else {
      if (heli_q8_DW.TimeStampA >= heli_q8_M->Timing.t[0]) {
        rtb_Backgain = heli_q8_DW.TimeStampB;
    ...
    rtb_PitchTransferFcn = (heli_q8_B.Gain1 - *lastU) / (heli_q8_M->Timing.t[0]
      - rtb_Backgain);
  }
   ...
   *  Sum: '<S5>/Sum'
   */
  rtb_PitchTransferFcn = heli_q8_P.w_0 * heli_q8_P.w_0 / (heli_q8_P.k_f *
    heli_q8_P.l_p / (2.0 * heli_q8_P.m_p * heli_q8_P.l_p * heli_q8_P.l_p)) *
    ((heli_q8_B.Scale - heli_q8_P.Gain2_Gain * heli_q8_B.Gain) * heli_q8_P.k_rp
     - heli_q8_B.Gain1) - 2.0 * heli_q8_P.w_0 / (heli_q8_P.k_f * heli_q8_P.l_p /
    (2.0 * heli_q8_P.m_p * heli_q8_P.l_p * heli_q8_P.l_p)) *
    rtb_PitchTransferFcn;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<Root>/Gain'
     */
    heli_q8_B.Sum = heli_q8_P.Gain_Gain_c * heli_q8_B.Gain_e -
      heli_q8_P.zerooutputconstant_Value;

    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<Root>/Constant'
     */
    rtb_DeadZoney = heli_q8_P.Constant_Value - heli_q8_B.Sum;
  ...
  if ((heli_q8_DW.TimeStampA_m >= heli_q8_M->Timing.t[0]) &&
      (heli_q8_DW.TimeStampB_f >= heli_q8_M->Timing.t[0])) {
    rtb_Backgain = 0.0;
  } else {
    rtb_Backgain = heli_q8_DW.TimeStampA_m;
    lastU = &heli_q8_DW.LastUAtTimeA_m;
    if (heli_q8_DW.TimeStampA_m < heli_q8_DW.TimeStampB_f) {
      if (heli_q8_DW.TimeStampB_f < heli_q8_M->Timing.t[0]) {
        rtb_Backgain = heli_q8_DW.TimeStampB_f;
        lastU = &heli_q8_DW.LastUAtTimeB_g;
      }
    } else {
      if (heli_q8_DW.TimeStampA_m >= heli_q8_M->Timing.t[0]) {
        rtb_Backgain = heli_q8_DW.TimeStampB_f;
    ...
    rtb_Backgain = (heli_q8_B.Sum - *lastU) / (heli_q8_M->Timing.t[0] -
      rtb_Backgain);
  }
   ...
   *  Gain: '<S6>/K_ed'
   */
  rtb_Frontgain = (rtb_Frontgain + heli_q8_B.K_ep) - heli_q8_P.K_ed_Gain *
    rtb_Backgain;

  /* Sum: '<S1>/Subtract' */
  rtb_Backgain = rtb_Frontgain - rtb_PitchTransferFcn;

  /* Gain: '<S1>/Front gain' incorporates:
   *  Sum: '<S1>/Add'
   */
  rtb_Frontgain = (rtb_PitchTransferFcn + rtb_Frontgain) *
  ...
  /* Gain: '<S1>/Back gain' */
  rtb_DeadZoney = heli_q8_P.Backgain_Gain * rtb_Backgain;
...
void heli_q8_update0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (heli_q8_DW.TimeStampA == (rtInf)) {
    heli_q8_DW.TimeStampA = heli_q8_M->Timing.t[0];
    lastU = &heli_q8_DW.LastUAtTimeA;
  } else if (heli_q8_DW.TimeStampB == (rtInf)) {
    heli_q8_DW.TimeStampB = heli_q8_M->Timing.t[0];
    lastU = &heli_q8_DW.LastUAtTimeB;
  } else if (heli_q8_DW.TimeStampA < heli_q8_DW.TimeStampB) {
    heli_q8_DW.TimeStampA = heli_q8_M->Timing.t[0];
    lastU = &heli_q8_DW.LastUAtTimeA;
  } else {
    heli_q8_DW.TimeStampB = heli_q8_M->Timing.t[0];
  ...
  *lastU = heli_q8_B.Gain1;

  /* End of Update for Derivative: '<Root>/Derivative1' */
  /* Update for Derivative: '<Root>/Derivative' */
  if (heli_q8_DW.TimeStampA_m == (rtInf)) {
    heli_q8_DW.TimeStampA_m = heli_q8_M->Timing.t[0];
    lastU = &heli_q8_DW.LastUAtTimeA_m;
  } else if (heli_q8_DW.TimeStampB_f == (rtInf)) {
    heli_q8_DW.TimeStampB_f = heli_q8_M->Timing.t[0];
    lastU = &heli_q8_DW.LastUAtTimeB_g;
  } else if (heli_q8_DW.TimeStampA_m < heli_q8_DW.TimeStampB_f) {
    heli_q8_DW.TimeStampA_m = heli_q8_M->Timing.t[0];
    lastU = &heli_q8_DW.LastUAtTimeA_m;
  } else {
    heli_q8_DW.TimeStampB_f = heli_q8_M->Timing.t[0];
...
void heli_q8_initialize(void)
{
  ...
  heli_q8_DW.TimeStampA = (rtInf);
  heli_q8_DW.TimeStampB = (rtInf);

  /* InitializeConditions for Integrator: '<S6>/Integrator' */
  heli_q8_X.Integrator_CSTATE = heli_q8_P.Integrator_IC;

  /* InitializeConditions for Derivative: '<Root>/Derivative' */
  heli_q8_DW.TimeStampA_m = (rtInf);
  heli_q8_DW.TimeStampB_f = (rtInf);
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (503566980U);
  heli_q8_M->Sizes.checksums[1] = (4157412518U);
  heli_q8_M->Sizes.checksums[2] = (1496533947U);
  heli_q8_M->Sizes.checksums[3] = (3615739277U);
  ...
  heli_q8_DW.TimeStampA = 0.0;
  heli_q8_DW.LastUAtTimeA = 0.0;
  heli_q8_DW.TimeStampB = 0.0;
  heli_q8_DW.LastUAtTimeB = 0.0;
  heli_q8_DW.TimeStampA_m = 0.0;
  heli_q8_DW.LastUAtTimeA_m = 0.0;
  heli_q8_DW.TimeStampB_f = 0.0;
  heli_q8_DW.LastUAtTimeB_g = 0.0;
