/*
 * heli_q8_part4_problem2_use_this_without_integrator.h
 *
 ...
 */
#ifndef RTW_HEADER_heli_q8_part4_problem2_use_this_without_integrator_h_
#define RTW_HEADER_heli_q8_part4_problem2_use_this_without_integrator_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_part4_problem2_use_this_without_integrator_COMMON_INCLUDES_
# define heli_q8_part4_problem2_use_this_without_integrator_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_part4_problem2_use_this_without_integrator_COMMON_INCLUDES_ */

#include "heli_q8_part4_problem2_use_this_without_integrator_types.h"
...
#define heli_q8_part4_problem2_use_this_without_integrator_rtModel RT_MODEL_heli_q8_part4_proble_T
...
} B_heli_q8_part4_problem2_use__T;
...
} DW_heli_q8_part4_problem2_use_T;
...
} X_heli_q8_part4_problem2_use__T;
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S5>/Elevation: Transfer Fcn' */
  real_T Integrator_CSTATE[6];         /* '<S4>/Integrator' */
} XDot_heli_q8_part4_problem2_u_T;
...
} XDis_heli_q8_part4_problem2_u_T;
...
#define rtB                            heli_q8_part4_problem2_use_th_B
#define BlockIO                        B_heli_q8_part4_problem2_use__T
#define rtX                            heli_q8_part4_problem2_use_th_X
#define ContinuousStates               X_heli_q8_part4_problem2_use__T
#define rtXdot                         heli_q8_part4_problem2_use_XDot
#define StateDerivatives               XDot_heli_q8_part4_problem2_u_T
#define tXdis                          heli_q8_part4_problem2_use_XDis
#define StateDisabled                  XDis_heli_q8_part4_problem2_u_T
#define rtP                            heli_q8_part4_problem2_use_th_P
#define Parameters                     P_heli_q8_part4_problem2_use__T
#define rtDWork                        heli_q8_part4_problem2_use_t_DW
#define D_Work                         DW_heli_q8_part4_problem2_use_T

/* Parameters (auto storage) */
struct P_heli_q8_part4_problem2_use__T_ {
  ...
  real_T Gain_Gain_lv;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T zerooutputconstant_Value;     /* Expression: 29
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Opp_Time;                     /* Expression: 10
                                        * Referenced by: '<S9>/Opp'
                                        */
  real_T Opp_Y0;                       /* Expression: 0
                                        * Referenced by: '<S9>/Opp'
                                        */
  real_T Opp_YFinal;                   /* Expression: 0.4
                                        * Referenced by: '<S9>/Opp'
                                        */
  real_T Ned_Time;                     /* Expression: 17
                                        * Referenced by: '<S9>/Ned'
                                        */
  real_T Ned_Y0;                       /* Expression: 0
                                        * Referenced by: '<S9>/Ned'
                                        */
  real_T Ned_YFinal;                   /* Expression: -0.4
                                        * Referenced by: '<S9>/Ned'
                                        */
  real_T Opp1_Time;                    /* Expression: 22
                                        * Referenced by: '<S8>/Opp1'
                                        */
  real_T Opp1_Y0;                      /* Expression: 0
                                        * Referenced by: '<S8>/Opp1'
                                        */
  real_T Opp1_YFinal;                  /* Expression: 0.2
                                        * Referenced by: '<S8>/Opp1'
                                        */
  real_T Ned1_Time;                    /* Expression: 25
                                        * Referenced by: '<S8>/Ned1'
                                        */
  real_T Ned1_Y0;                      /* Expression: 0
                                        * Referenced by: '<S8>/Ned1'
                                        */
  real_T Ned1_YFinal;                  /* Expression: -0.2
                                        * Referenced by: '<S8>/Ned1'
                                        */
  ...
  real_T Constant_Value;               /* Expression: 1
                                        ...
                                        */
  real_T Gain_Gain_j;                  /* Expression: 0
...
struct tag_RTM_heli_q8_part4_problem_T {
  const char_T *path;
...
extern P_heli_q8_part4_problem2_use__T heli_q8_part4_problem2_use_th_P;

/* Block signals (auto storage) */
extern B_heli_q8_part4_problem2_use__T heli_q8_part4_problem2_use_th_B;

/* Continuous states (auto storage) */
extern X_heli_q8_part4_problem2_use__T heli_q8_part4_problem2_use_th_X;

/* Block states (auto storage) */
extern DW_heli_q8_part4_problem2_use_T heli_q8_part4_problem2_use_t_DW;
...
extern void heli_q8_part4_problem2_use_this_without_integrator_initialize(void);
extern void heli_q8_part4_problem2_use_this_without_integrator_output0(void);
extern void heli_q8_part4_problem2_use_this_without_integrator_update0(void);
extern void heli_q8_part4_problem2_use_this_without_integrator_output(int_T tid);
extern void heli_q8_part4_problem2_use_this_without_integrator_update(int_T tid);
extern void heli_q8_part4_problem2_use_this_without_integrator_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_part4_proble_T *const heli_q8_part4_problem2_use_t_M;
 ...
 *
 * '<Root>' : 'heli_q8_part4_problem2_use_this_without_integrator'
 * '<S1>'   : 'heli_q8_part4_problem2_use_this_without_integrator/ Switch on elevation controller'
 * '<S2>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Conversion'
 * '<S3>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Degrees to Radians'
 * '<S4>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Estimator'
 * '<S5>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D'
 * '<S6>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Joystick'
 * '<S7>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Multivariable controller 1'
 * '<S8>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Step generator elevation'
 * '<S9>'   : 'heli_q8_part4_problem2_use_this_without_integrator/Step generator pitch'
 * '<S10>'  : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'heli_q8_part4_problem2_use_this_without_integrator/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_part4_problem2_use_this_without_integrator_h_ */
