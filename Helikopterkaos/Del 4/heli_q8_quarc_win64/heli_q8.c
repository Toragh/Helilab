 ...
 * C source code generated on : Wed Sep 19 11:22:43 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.Gain1[0] += heli_q8_P.P[0] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain1[0] += heli_q8_P.P[2] * heli_q8_B.Joystick_gain_y;
    heli_q8_B.Gain1[1] = 0.0;
    heli_q8_B.Gain1[1] += heli_q8_P.P[1] * heli_q8_B.Joystick_gain_x;
    heli_q8_B.Gain1[1] += heli_q8_P.P[3] * heli_q8_B.Joystick_gain_y;
    ...
    /* Gain: '<S10>/Gain' */
    heli_q8_B.Gain = heli_q8_P.Gain_Gain * heli_q8_B.PitchCounttorad;
  }
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_Sum_p[i] = heli_q8_B.Gain1[i] - ((heli_q8_P.K[i + 2] * heli_q8_B.Gain_b
      + heli_q8_P.K[i] * heli_q8_B.Gain) + heli_q8_P.K[i + 4] * heli_q8_B.Gain_d);
  }
  ...
  heli_q8_B.Gain_dc = (heli_q8_P.TravelTransferFcn_C *
                       ...
                       heli_q8_B.TravelCounttorad) * heli_q8_P.Gain_Gain_lu;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S12>/Gain' */
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Sum_p[0] + rtb_Sum_p[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Sum_p[1] - rtb_Sum_p[0]) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (92636361U);
  heli_q8_M->Sizes.checksums[1] = (3129587549U);
  heli_q8_M->Sizes.checksums[2] = (3287917289U);
  heli_q8_M->Sizes.checksums[3] = (378605785U);
