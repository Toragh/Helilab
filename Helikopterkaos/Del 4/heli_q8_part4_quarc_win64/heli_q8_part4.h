 ...
 */
#ifndef RTW_HEADER_heli_q8_part4_h_
#define RTW_HEADER_heli_q8_part4_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_part4_COMMON_INCLUDES_
# define heli_q8_part4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_part4_COMMON_INCLUDES_ */

#include "heli_q8_part4_types.h"
...
#define heli_q8_part4_rtModel          RT_MODEL_heli_q8_part4_T
...
#define rtB                            heli_q8_part4_B
#define BlockIO                        B_heli_q8_part4_T
#define rtX                            heli_q8_part4_X
#define ContinuousStates               X_heli_q8_part4_T
#define rtXdot                         heli_q8_part4_XDot
#define StateDerivatives               XDot_heli_q8_part4_T
#define tXdis                          heli_q8_part4_XDis
#define StateDisabled                  XDis_heli_q8_part4_T
#define rtP                            heli_q8_part4_P
#define Parameters                     P_heli_q8_part4_T
#define rtDWork                        heli_q8_part4_DW
#define D_Work                         DW_heli_q8_part4_T

/* Parameters (auto storage) */
struct P_heli_q8_part4_T_ {
...
struct tag_RTM_heli_q8_part4_T {
  const char_T *path;
...
extern P_heli_q8_part4_T heli_q8_part4_P;

/* Block signals (auto storage) */
extern B_heli_q8_part4_T heli_q8_part4_B;

/* Continuous states (auto storage) */
extern X_heli_q8_part4_T heli_q8_part4_X;

/* Block states (auto storage) */
extern DW_heli_q8_part4_T heli_q8_part4_DW;
...
extern void heli_q8_part4_initialize(void);
extern void heli_q8_part4_output0(void);
extern void heli_q8_part4_update0(void);
extern void heli_q8_part4_output(int_T tid);
extern void heli_q8_part4_update(int_T tid);
extern void heli_q8_part4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_part4_T *const heli_q8_part4_M;
 ...
 *
 * '<Root>' : 'heli_q8_part4'
 * '<S1>'   : 'heli_q8_part4/ Switch on elevation controller'
 * '<S2>'   : 'heli_q8_part4/Conversion'
 * '<S3>'   : 'heli_q8_part4/Degrees to Radians'
 * '<S4>'   : 'heli_q8_part4/Estimator'
 * '<S5>'   : 'heli_q8_part4/Heli 3D'
 * '<S6>'   : 'heli_q8_part4/Joystick'
 * '<S7>'   : 'heli_q8_part4/Multivariable controller '
 * '<S8>'   : 'heli_q8_part4/Step generator elevation'
 * '<S9>'   : 'heli_q8_part4/Step generator pitch'
 * '<S10>'  : 'heli_q8_part4/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'heli_q8_part4/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'heli_q8_part4/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'heli_q8_part4/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'heli_q8_part4/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'heli_q8_part4/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_part4_h_ */
