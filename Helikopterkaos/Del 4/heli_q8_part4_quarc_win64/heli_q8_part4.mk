...
MODEL                = heli_q8_part4
MODULES              = heli_q8_part4_data.c heli_q8_part4_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_part4.mk
...
MODELLIB                  = heli_q8_part4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_part4_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_part4_quarc_win64
