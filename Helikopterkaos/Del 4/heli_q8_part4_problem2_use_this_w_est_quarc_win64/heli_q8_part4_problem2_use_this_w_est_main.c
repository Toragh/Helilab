 ...
 * External functions *
 *====================*/
EXTERN RT_MODEL * heli_q8_part4_problem2_use_this_w_est(void);
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://heli_q8_part4_problem2_use_this_w_est:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: heli_q8_part4_problem2_use_this_w_est -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = heli_q8_part4_problem2_use_this_w_est();
  if (rtmGetErrorStatus(S) != NULL) {
