...
struct P_heli_q8_part3_problem3_m_in_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Opp_Time;                     /* Expression: 5
                                        * Referenced by: '<S7>/Opp'
                                        */
  real_T Opp_Y0;                       /* Expression: 0
                                        * Referenced by: '<S7>/Opp'
                                        */
  real_T Opp_YFinal;                   /* Expression: 0.8
                                        * Referenced by: '<S7>/Opp'
                                        */
  real_T Ned_Time;                     /* Expression: 8
                                        * Referenced by: '<S7>/Ned'
                                        */
  real_T Ned_Y0;                       /* Expression: 0
                                        * Referenced by: '<S7>/Ned'
                                        */
  real_T Ned_YFinal;                   /* Expression: -0.8
                                        * Referenced by: '<S7>/Ned'
                                        */
  real_T Opp1_Time;                    /* Expression: 12
                                        * Referenced by: '<S6>/Opp1'
                                        */
  real_T Opp1_Y0;                      /* Expression: 0
                                        * Referenced by: '<S6>/Opp1'
                                        */
  real_T Opp1_YFinal;                  /* Expression: 0.3
                                        * Referenced by: '<S6>/Opp1'
                                        */
  real_T Ned1_Time;                    /* Expression: 14
                                        * Referenced by: '<S6>/Ned1'
                                        */
  real_T Ned1_Y0;                      /* Expression: 0
                                        * Referenced by: '<S6>/Ned1'
                                        */
  real_T Ned1_YFinal;                  /* Expression: -0.3
                                        * Referenced by: '<S6>/Ned1'
                                        */
 ...
 * '<S8>'   : 'heli_q8_part3_problem3_m_integral/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'heli_q8_part3_problem3_m_integral/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'heli_q8_part3_problem3_m_integral/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'heli_q8_part3_problem3_m_integral/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'heli_q8_part3_problem3_m_integral/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'heli_q8_part3_problem3_m_integral/Heli 3D/Travel rate  rad to deg'
 */
