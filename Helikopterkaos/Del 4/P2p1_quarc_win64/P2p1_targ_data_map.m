  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P2p1_P.Joysticksensitivity_Gain
	  ...
	  ;% P2p1_P.zerooutputconstant_Value
	  section.data(28).logicalSrcIdx = 102;
	  section.data(28).dtTransOffset = 27;
	
	  ;% P2p1_P.Reference_Value
  ...
  targMap.checksum0 = 3496321899;
  targMap.checksum1 = 176537102;
  targMap.checksum2 = 1981089680;
  targMap.checksum3 = 3295359450;
