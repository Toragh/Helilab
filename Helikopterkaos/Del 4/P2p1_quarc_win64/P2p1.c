 ...
 * C source code generated on : Wed Oct 17 22:53:46 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitionx > P2p1_P.DeadZonex_End) {
      rtb_Gain1_idx_4 = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_End;
    } else if (P2p1_B.RateTransitionx >= P2p1_P.DeadZonex_Start) {
      rtb_Gain1_idx_4 = 0.0;
    } else {
      rtb_Gain1_idx_4 = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S5>/Gain: x'
     */
    P2p1_B.Joystick_gain_x = P2p1_P.Gainx_Gain * rtb_Gain1_idx_4 *
      P2p1_P.Joystick_gain_x;

    /* Gain: '<Root>/Joystick sensitivity ' */
    P2p1_B.Joysticksensitivity = P2p1_P.Joysticksensitivity_Gain *
  ...
  /* Gain: '<S2>/Gain1' */
  rtb_Gain1_idx_4 = P2p1_P.Gain1_Gain * P2p1_B.Gain_e;
  rtb_Gain1_idx_5 = P2p1_P.Gain1_Gain * P2p1_B.Gain_dg;
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Frontgain = P2p1_P.w_0 * P2p1_P.w_0 / (P2p1_P.k_f * P2p1_P.l_p / (2.0 *
    P2p1_P.m_p * P2p1_P.l_p * P2p1_P.l_p)) * (P2p1_B.Joysticksensitivity -
    P2p1_P.Gain1_Gain * P2p1_B.Gain_i) - 2.0 * P2p1_P.w_0 / (P2p1_P.k_f *
    P2p1_P.l_p / (2.0 * P2p1_P.m_p * P2p1_P.l_p * P2p1_P.l_p)) *
    (P2p1_P.Gain1_Gain * P2p1_B.Gain_b);
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    P2p1_B.zerooutputconstant = P2p1_P.zerooutputconstant_Value;

    /* Constant: '<Root>/Reference' */
    P2p1_B.Reference = P2p1_P.Reference_Value;
  }

  /* Sum: '<S3>/Sum' incorporates:
   *  Sum: '<Root>/Sum2'
   */
  rtb_Sum_p = P2p1_B.Reference - (rtb_Gain1_idx_4 - P2p1_B.zerooutputconstant);
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Constant: '<Root>/V_s+' */
    P2p1_B.V_s = P2p1_P.v_star;
  }
  ...
  rtb_Backgain = ((P2p1_P.K_ep_Gain * rtb_Sum_p + rtb_Backgain) -
                  P2p1_P.K_ed_Gain * rtb_Gain1_idx_5) + P2p1_B.V_s;
  ...
  /* Gain: '<S1>/Front gain' */
  rtb_Gain1_idx_4 *= P2p1_P.Frontgain_Gain;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (rtb_Gain1_idx_4 > P2p1_P.FrontmotorSaturation_UpperSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Gain1_idx_4 < P2p1_P.FrontmotorSaturation_LowerSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_LowerSat;
  } else {
    P2p1_B.FrontmotorSaturation = rtb_Gain1_idx_4;
  }
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitiony > P2p1_P.DeadZoney_End) {
      rtb_Gain1_idx_4 = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_End;
    } else if (P2p1_B.RateTransitiony >= P2p1_P.DeadZoney_Start) {
      rtb_Gain1_idx_4 = 0.0;
    } else {
      rtb_Gain1_idx_4 = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S5>/Gain: y'
     */
    P2p1_B.Joystick_gain_y = P2p1_P.Gainy_Gain * rtb_Gain1_idx_4 *
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (3496321899U);
  P2p1_M->Sizes.checksums[1] = (176537102U);
  P2p1_M->Sizes.checksums[2] = (1981089680U);
  P2p1_M->Sizes.checksums[3] = (3295359450U);
...

  {
    ...
    P2p1_B.Joysticksensitivity = 0.0;
    ...
    P2p1_B.Gain_e = 0.0;
    P2p1_B.Gain_dg = 0.0;
    P2p1_B.zerooutputconstant = 0.0;
    P2p1_B.Reference = 0.0;
    P2p1_B.V_s = 0.0;
    P2p1_B.K_ei = 0.0;
  ...
  P2p1_M->Sizes.numBlocks = (55);      /* Number of blocks */
