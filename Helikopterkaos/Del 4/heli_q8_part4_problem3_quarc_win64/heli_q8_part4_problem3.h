 ...
 */
#ifndef RTW_HEADER_heli_q8_part4_problem3_h_
#define RTW_HEADER_heli_q8_part4_problem3_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_part4_problem3_COMMON_INCLUDES_
# define heli_q8_part4_problem3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_part4_problem3_COMMON_INCLUDES_ */

#include "heli_q8_part4_problem3_types.h"
...
#define heli_q8_part4_problem3_rtModel RT_MODEL_heli_q8_part4_proble_T
...
typedef struct {
  ...
  real_T Gain1_o[2];                   /* '<S7>/Gain1' */
  real_T Gain_o;                       /* '<Root>/Gain' */
  real_T V_s;                          /* '<Root>/V_s*    ' */
  real_T Sum3[6];                      /* '<S4>/Sum3' */
...
#define rtB                            heli_q8_part4_problem3_B
#define BlockIO                        B_heli_q8_part4_problem3_T
#define rtX                            heli_q8_part4_problem3_X
#define ContinuousStates               X_heli_q8_part4_problem3_T
#define rtXdot                         heli_q8_part4_problem3_XDot
#define StateDerivatives               XDot_heli_q8_part4_problem3_T
#define tXdis                          heli_q8_part4_problem3_XDis
#define StateDisabled                  XDis_heli_q8_part4_problem3_T
#define rtP                            heli_q8_part4_problem3_P
#define Parameters                     P_heli_q8_part4_problem3_T
#define rtDWork                        heli_q8_part4_problem3_DW
#define D_Work                         DW_heli_q8_part4_problem3_T

/* Parameters (auto storage) */
struct P_heli_q8_part4_problem3_T_ {
  ...
  real_T B_est[12];                    /* Variable: B_est
                                        ...
                                        */
  real_T C_est[12];                    /* Variable: C_est
...
extern P_heli_q8_part4_problem3_T heli_q8_part4_problem3_P;

/* Block signals (auto storage) */
extern B_heli_q8_part4_problem3_T heli_q8_part4_problem3_B;

/* Continuous states (auto storage) */
extern X_heli_q8_part4_problem3_T heli_q8_part4_problem3_X;

/* Block states (auto storage) */
extern DW_heli_q8_part4_problem3_T heli_q8_part4_problem3_DW;
...
extern void heli_q8_part4_problem3_initialize(void);
extern void heli_q8_part4_problem3_output0(void);
extern void heli_q8_part4_problem3_update0(void);
extern void heli_q8_part4_problem3_output(int_T tid);
extern void heli_q8_part4_problem3_update(int_T tid);
extern void heli_q8_part4_problem3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_part4_proble_T *const heli_q8_part4_problem3_M;
 ...
 *
 * '<Root>' : 'heli_q8_part4_problem3'
 * '<S1>'   : 'heli_q8_part4_problem3/ Switch on elevation controller'
 * '<S2>'   : 'heli_q8_part4_problem3/Conversion'
 * '<S3>'   : 'heli_q8_part4_problem3/Degrees to Radians'
 * '<S4>'   : 'heli_q8_part4_problem3/Estimator'
 * '<S5>'   : 'heli_q8_part4_problem3/Heli 3D'
 * '<S6>'   : 'heli_q8_part4_problem3/Joystick'
 * '<S7>'   : 'heli_q8_part4_problem3/Multivariable controller '
 * '<S8>'   : 'heli_q8_part4_problem3/Step generator elevation'
 * '<S9>'   : 'heli_q8_part4_problem3/Step generator pitch'
 * '<S10>'  : 'heli_q8_part4_problem3/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'heli_q8_part4_problem3/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'heli_q8_part4_problem3/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'heli_q8_part4_problem3/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'heli_q8_part4_problem3/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'heli_q8_part4_problem3/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_part4_problem3_h_ */
