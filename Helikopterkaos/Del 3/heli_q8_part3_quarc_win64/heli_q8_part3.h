 ...
 */
#ifndef RTW_HEADER_heli_q8_part3_h_
#define RTW_HEADER_heli_q8_part3_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_part3_COMMON_INCLUDES_
# define heli_q8_part3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_part3_COMMON_INCLUDES_ */

#include "heli_q8_part3_types.h"
...
#define heli_q8_part3_rtModel          RT_MODEL_heli_q8_part3_T
...
#define rtB                            heli_q8_part3_B
#define BlockIO                        B_heli_q8_part3_T
#define rtX                            heli_q8_part3_X
#define ContinuousStates               X_heli_q8_part3_T
#define rtXdot                         heli_q8_part3_XDot
#define StateDerivatives               XDot_heli_q8_part3_T
#define tXdis                          heli_q8_part3_XDis
#define StateDisabled                  XDis_heli_q8_part3_T
#define rtP                            heli_q8_part3_P
#define Parameters                     P_heli_q8_part3_T
#define rtDWork                        heli_q8_part3_DW
#define D_Work                         DW_heli_q8_part3_T

/* Parameters (auto storage) */
struct P_heli_q8_part3_T_ {
...
struct tag_RTM_heli_q8_part3_T {
  const char_T *path;
...
extern P_heli_q8_part3_T heli_q8_part3_P;

/* Block signals (auto storage) */
extern B_heli_q8_part3_T heli_q8_part3_B;

/* Continuous states (auto storage) */
extern X_heli_q8_part3_T heli_q8_part3_X;

/* Block states (auto storage) */
extern DW_heli_q8_part3_T heli_q8_part3_DW;
...
extern void heli_q8_part3_initialize(void);
extern void heli_q8_part3_output0(void);
extern void heli_q8_part3_update0(void);
extern void heli_q8_part3_output(int_T tid);
extern void heli_q8_part3_update(int_T tid);
extern void heli_q8_part3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_part3_T *const heli_q8_part3_M;
 ...
 *
 * '<Root>' : 'heli_q8_part3'
 * '<S1>'   : 'heli_q8_part3/Conversion'
 * '<S2>'   : 'heli_q8_part3/Degrees to Radians'
 * '<S3>'   : 'heli_q8_part3/Elevation controller'
 * '<S4>'   : 'heli_q8_part3/Heli 3D'
 * '<S5>'   : 'heli_q8_part3/Joystick'
 * '<S6>'   : 'heli_q8_part3/Multivariable controller '
 * '<S7>'   : 'heli_q8_part3/Pitch controller'
 * '<S8>'   : 'heli_q8_part3/Elevation controller/Elevation controller'
 * '<S9>'   : 'heli_q8_part3/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'heli_q8_part3/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'heli_q8_part3/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'heli_q8_part3/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'heli_q8_part3/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'heli_q8_part3/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_part3_h_ */
