  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P3p3_P.zerooutputconstant_Value
	  ...
	  ;% P3p3_P.Constant2_Value
	  section.data(32).logicalSrcIdx = 104;
	  section.data(32).dtTransOffset = 31;
	
	  ;% P3p3_P.Switch_Threshold
  ...
  targMap.checksum0 = 3181721150;
  targMap.checksum1 = 856586579;
  targMap.checksum2 = 1321590972;
  targMap.checksum3 = 3361491988;
