...
struct P_P3p3_T_ {
  ...
  real_T Integrator1_IC;               /* Expression: 0
                                        ...
                                        */
  real_T V_d_Value;                    /* Expression: 1
                                        * Referenced by: '<Root>/V_d+'
                                        */
 ...
 * '<S3>'   : 'P3p3/Heli 3D'
 * '<S4>'   : 'P3p3/Joystick'
 * '<S5>'   : 'P3p3/Multivariable controller '
 * '<S6>'   : 'P3p3/Step generator elevation'
 * '<S7>'   : 'P3p3/Step generator pitch'
 * '<S8>'   : 'P3p3/Switch on elev controller'
