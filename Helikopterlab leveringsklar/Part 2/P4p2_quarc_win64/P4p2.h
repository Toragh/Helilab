 ...
 *
 * '<Root>' : 'P4p2'
 * '<S1>'   : 'P4p2/ Switch on elevation controller'
 * '<S2>'   : 'P4p2/Conversion'
 * '<S3>'   : 'P4p2/Degrees to Radians'
 * '<S4>'   : 'P4p2/Estimator'
 * '<S5>'   : 'P4p2/Heli 3D'
 * '<S6>'   : 'P4p2/Joystick'
 * '<S7>'   : 'P4p2/Multivariable controller 1'
 * '<S8>'   : 'P4p2/Step generator elevation'
 * '<S9>'   : 'P4p2/Step generator pitch'
