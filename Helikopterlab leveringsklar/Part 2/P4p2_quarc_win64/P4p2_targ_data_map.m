  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p2_P.zerooutputconstant_Value
	  ...
	  ;% P4p2_P.Constant2_Value
	  section.data(33).logicalSrcIdx = 109;
	  section.data(33).dtTransOffset = 32;
	
	  ;% P4p2_P.Switch_Threshold
  ...
  targMap.checksum0 = 3928455584;
  targMap.checksum1 = 3798557980;
  targMap.checksum2 = 3044183647;
  targMap.checksum3 = 3855577670;
