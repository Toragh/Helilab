  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p2_integral_P.Step_Time
	  section.data(30).logicalSrcIdx = 106;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P4p2_integral_P.Step_Y0
	  section.data(31).logicalSrcIdx = 107;
	  section.data(31).dtTransOffset = 30;
	
	  ;% P4p2_integral_P.Step_YFinal
	  ...
	  ;% P4p2_integral_P.Switch_Threshold
	  ...
	  ;% P4p2_integral_P.Integrator_IC_o
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p2_integral_B.Switch
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 27;
	
	  ;% P4p2_integral_B.Gain1_o
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 28;
	
	  ;% P4p2_integral_B.Gain_o
	  section.data(20).logicalSrcIdx = 19;
  ...
  targMap.checksum0 = 3085037992;
  targMap.checksum1 = 258508123;
  targMap.checksum2 = 4228591802;
  targMap.checksum3 = 1927676939;
