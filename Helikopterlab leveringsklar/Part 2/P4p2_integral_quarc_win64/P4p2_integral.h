 ...
 *
 * '<Root>' : 'P4p2_integral'
 * '<S1>'   : 'P4p2_integral/ Switch on elevation controller'
 * '<S2>'   : 'P4p2_integral/Conversion'
 * '<S3>'   : 'P4p2_integral/Degrees to Radians'
 * '<S4>'   : 'P4p2_integral/Estimator'
 * '<S5>'   : 'P4p2_integral/Heli 3D'
 * '<S6>'   : 'P4p2_integral/Joystick'
 * '<S7>'   : 'P4p2_integral/Multivariable controller '
 * '<S8>'   : 'P4p2_integral/Step generator elevation'
 * '<S9>'   : 'P4p2_integral/Step generator pitch'
