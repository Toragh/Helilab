 ...
 *
 * '<Root>' : 'P4p3'
 * '<S1>'   : 'P4p3/ Switch on elevation controller'
 * '<S2>'   : 'P4p3/Conversion'
 * '<S3>'   : 'P4p3/Degrees to Radians'
 * '<S4>'   : 'P4p3/Estimator'
 * '<S5>'   : 'P4p3/Heli 3D'
 * '<S6>'   : 'P4p3/Joystick'
 * '<S7>'   : 'P4p3/Multivariable controller '
 * '<S8>'   : 'P4p3/Step generator elevation'
 * '<S9>'   : 'P4p3/Step generator pitch'
